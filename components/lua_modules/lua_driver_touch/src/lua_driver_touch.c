...
#define LUA_DRIVER_TOUCH_DEFAULT_NAME     "touch_keys"
#define LUA_DRIVER_TOUCH_MAX_NAME_LEN     64
#define LUA_DRIVER_TOUCH_MAX_KEYS         2
...
static esp_err_t lua_driver_touch_load_board_defaults(const char *device_name,
                                                      lua_touch_resolved_cfg_t *out)
{
    ...
    if (board->key2_gpio_num > 0 && out->key_count < LUA_DRIVER_TOUCH_MAX_KEYS) {
...
static int lua_driver_touch_new(lua_State *L)
{
    ...
    (void)lua_driver_touch_load_board_defaults(device_name, &cfg);
